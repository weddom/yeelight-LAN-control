package com.yeelightcontrol.color;
...
public class ColorView extends View {
    ...
    public void init(@Nullable AttributeSet set) {
        ...
        if (set != null) {
            ...
            mBackgroundResourceId = typedArray.getResourceId(R.styleable.colorView_backGround_image, R.drawable.ic_baseline_refresh_24);
